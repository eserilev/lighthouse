...
use types::{
    AttestationData, AttesterSlashingRef, BeaconBlockRef, BeaconState,
...
pub struct ValidatorMonitor<E: EthSpec> {
    ...
    unaggregated_attestations: HashMap<Slot, SingleAttestation>,
    log: Logger,
...
impl<E: EthSpec> ValidatorMonitor<E> {
    ...
    pub fn set_unaggregated_attestation(&mut self, attestation: SingleAttestation) {
    ...
    pub fn get_unaggregated_attestation(&self, slot: Slot) -> Option<&SingleAttestation> {
